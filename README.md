...
- **Natural Language Processing(NLP)** - Processing text data to extract insights, such as tendency and emotion classification *[Reference](https://github.com/ISL-0111/IDS703_NLP_Project_Political_Tendency_Analysis/blob/main/README.md)*
...
- **Domain Knowledge** - Power & Utility Industry, Human Resource Development & Management (HRM/HRD)
